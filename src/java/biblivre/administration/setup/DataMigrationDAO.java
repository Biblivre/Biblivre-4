...
public class DataMigrationDAO extends AbstractDAO {
	...
	public List<LendingDTO> listLendings(int limit, int offset) {
		...
		try {
			...
			while (rs.next()) {
				...
				dto.setCreatedBy(1);
				dto.setCreated(rs.getDate("lending_date"));				
	...
	private String getUserFieldColumnName(String biblivre4UserFieldKey) {
		...
		if (biblivre4UserFieldKey.equals("cellphone")) {
			columnName = "cellphone";
		} else if (biblivre4UserFieldKey.equals("email")) {
			columnName = "email";
		} else if (biblivre4UserFieldKey.equals("gender")) {
			columnName = "sex";
		} else if (biblivre4UserFieldKey.equals("obs")) {
			columnName = "obs";
		} else if (biblivre4UserFieldKey.equals("phone")) {
			columnName = "tel_ref_1";
		}
		
		return columnName;
		
		//TODO define what we gonna use on biblivre4 from the fields below.
//  social_id_number character varying(50), //CPF
//  dlicense character varying(50), //Identidade
//  type_id character varying(50), //NA
//  birthday date, //DATA NASCIMENTO
//  marital_status character varying(50), //NA
//  occupatio character varying(50), //NA
//  father_name character varying(256), //NA
//  mother_name character varying(256), //NA
//  reference_1 character varying(256), //NA
//  reference_2 character varying(255), //NA
//  tel_ref_2 character varying(50), //TELEFONE COMERCIAL
//  country character varying(50), //NA
//  state character varying(50), //ESTADO
//  city character varying(50), //CIDADE
//  address character varying(256), //ENDEREÇO
//  "number" character varying(50), //NUMERO
//  completion character varying(50), //COMPLEMENTO
//  zip_code character varying(50), //CEP
//  extension_line character varying(50), //RAMAL
