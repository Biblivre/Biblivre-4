...
public class ReportsBO extends AbstractBO {
	...
	public TreeMap<String, Set<Integer>> searchAuthors(String author, RecordDatabase database, int offset, int limit) {
		return this.dao.searchAuthors(author, database, offset, limit);
	}
