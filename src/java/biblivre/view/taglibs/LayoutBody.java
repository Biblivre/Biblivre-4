...
public class LayoutBody extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			out.println("        <img src=\"static/images/logo_biblivre.png\" width=\"117\" height=\"66\" alt=\"Biblivre 4\">");
			out.println("      </a>");
			out.println("    </div>");
			...
			out.println("        <a href=\"http://biblivre.org.br/\" target=\"_blank\">");
			out.println("          <img src=\"static/images/logo_biblivre_small.png\" width=\"43\" height=\"36\" alt=\"Biblivre 4\">");
			out.println("        </a>");
			out.println("      </div>");			
