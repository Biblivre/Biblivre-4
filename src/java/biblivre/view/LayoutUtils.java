...
public class LayoutUtils {
	...
	public String menuItem(AuthorizationPoints atps, String module, String action) {
		...
		if (allowed) {
			return String.format("<li class=\"submenu_%1$s\" data-action=\"%2$s\"><a href=\"?action=%2$s\">%3$s</a></li>", module, action, this.translationsMap.getText("menu." + action));
		} else {
	...
	public String menuHelp(AuthorizationPoints atps) {
		...
		sb.append("<li class=\"submenu_help\"><a href=\"http://www.biblivre.org.br/forum/viewforum.php?f=30\" target=\"_blank\">").append(this.translationsMap.getText("menu.help_faq")).append("</a></li>");
		sb.append("<li class=\"submenu_help\"><a href=\"static/Manual_Biblivre.pdf\" target=\"_blank\">").append(this.translationsMap.getText("menu.help_manual")).append("</a></li>");
