...
#-------------------------------------------------------------------------------
var RequestInput = new Input({
	initialize: function() {
		$('#biblivre_request_form_body').setTemplateElement('biblivre_request_form_body_template');
		$('#biblivre_request_form').setTemplateElement('biblivre_request_form_template');
		$('#biblivre_request_info_form').setTemplateElement('biblivre_request_info_form_template');
	...
	setAsReadOnly: function() {
		var root = $('#biblivre_request_form_body, #biblivre_request_form, #biblivre_request_info_form');
	...
	getSaveRecord: function(saveAsNew) {
		var params = {};
		$('#biblivre_request_form_body :input').each(function() {
			var input = $(this);
			params[input.attr('name')] = input.val();
		});
		$('#biblivre_request_form :input').each(function() {
			var input = $(this);
			params[input.attr('name')] = input.val();
		});
		$('#biblivre_request_info_form :input').each(function() {
			var input = $(this);
			params[input.attr('name')] = input.val();
		});
