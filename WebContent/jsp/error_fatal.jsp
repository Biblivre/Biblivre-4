...
<body>
	<div id="header">
		<div id="logo_biblivre">
			<a href="http://biblivre.org.br/" target="_blank"> <img src="static/images/logo_biblivre.png" width="117" height="66" alt="Biblivre 4"></a>
		</div>
	</div>
	<div id="notifications">
		<div id="messages">
			...
			<% } else if (((ExtendedResponse) response).getStatus() == HttpStatus.SC_NOT_FOUND) { %>
				<div>
