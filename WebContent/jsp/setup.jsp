...
<layout:body disableMenu="true" multiPart="true">
	...
	<div class="biblivre_form">
		...
		<fieldset>
			...
			<div class="spacer"></div>
			<div class="buttons">
				<a class="main_button arrow_right" onclick="Administration.setup.cleanInstall();"><i18n:text key="administration.setup.clean_install.button" /></a>
			</div>
		</fieldset>	
		...
		<fieldset>
			...
			<div class="restore">
				<div class="last_backups">
					...
					<div id="last_backups_list" class="last_backups_list"></div>
